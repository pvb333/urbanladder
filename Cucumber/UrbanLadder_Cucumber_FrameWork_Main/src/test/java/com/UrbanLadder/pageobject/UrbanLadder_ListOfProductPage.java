...
public class UrbanLadder_ListOfProductPage extends UrbanLadder_HomePage {
	...
	public static void verifyselecttable() throws IOException
	{
	...
	public static void verifyinstockproduct() throws FileNotFoundException, IOException, InterruptedException
	{
	...
	public static void sortResult() throws InterruptedException
	{
	...
	public static void verifysortresult() throws InterruptedException, IOException
	{
		for(int i=1;i<=20;i++)
		 {
	...
	public static void selectProduct(String productname) throws FileNotFoundException, IOException, InterruptedException
	{
