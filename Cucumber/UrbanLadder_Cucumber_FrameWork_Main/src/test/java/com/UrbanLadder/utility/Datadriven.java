...
public class Datadriven {
	public static String datadriver(String inp) throws IOException
	{
		...
		FileInputStream fis=new FileInputStream("C:\\Users\\Nitin\\eclipse-workspace\\UrbanLadder_Cucumber_FrameWork_Main\\testdata\\datadriven.properties"); // all these packages comes under selenium jars
		prop.load(fis);
